...
const products = [
  ...
  { id:4, name:"Caméra de sécurité connectée", category:"Sécurité", price:28000, spec:"Contrôle à distance • Vision nocturne", image:"/assets/fantomas-original/camera-connected.webp", status:"En stock", badge:"Focus sécurité" },
  { id:5, name:"Hub USB Type-C multifonction", category:"Informatique", price:15000, spec:"Connectique étendue pour votre bureau", image:"/assets/fantomas-original/hub-usbc.webp", status:"En stock" },
  { id:6, name:"DRONE M3 MAX", category:"Drones", price:28000, spec:"Caméra • Pliable • Télécommande", image:"/assets/fantomas-original/drone-m3.webp", status:"En stock" },
  { id:7, name:"Écouteurs Bluetooth sans fil", category:"Audio", price:12000, spec:"Appels • Mobilité • Autonomie", image:"/assets/product-headphones.jpg", status:"En stock" },
  { id:8, name:"CHARGEUR SANS FIL", category:"Énergie", price:10000, spec:"Recharge pratique au quotidien", image:"/assets/fantomas-original/charger-wireless.webp", status:"En stock" },
];
